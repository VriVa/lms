  ...
  return (
    ...
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      <div className='flex md:flex-row flex-col gap-6 items-start justify-between w-full'>
        <div>
        <h1 className='text-4xl font-semibold txt-gray-800'>Course List</h1>
      ...
      {
        input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-8 mb-9 text-gray-600'>
          <p>{input}</p>
